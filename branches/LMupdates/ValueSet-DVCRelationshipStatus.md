...
| Draft as of 2026-08-31 | *Computable Name*:DVCRelationshipStatus |
...
##### Relationship Status for Contact in Patient Schema API
...
### GET /ValueSet-DVCRelationshipStatus.schema.json

#### JSON Schema definition for the enumeration ValueSet-DVCRelationshipStatus

This endpoint serves the JSON Schema definition for the enumeration ValueSet-DVCRelationshipStatus.
...
```json
{
  ...
  "url" : "http://smart.who.int/trust-phw/ValueSet/DVCRelationshipStatus",
  "version" : "0.1.0",
