...
```json
{
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "http://smart.who.int/trust-phw/StructureDefinition/DVCMinVaccineDetailsPreQual",
  "baseDefinition" : "http://smart.who.int/trust-phw/StructureDefinition/DVCMinVaccineDetails",
  "derivation" : "specialization",
  "differential" : {
    "element" : [{
      "id" : "DVCMinVaccineDetailsPreQual",
      "path" : "DVCMinVaccineDetailsPreQual",
    ...
    {
      "id" : "DVCMinVaccineDetailsPreQual.vp",
      "path" : "DVCMinVaccineDetailsPreQual.vp",
      "binding" : {
        "strength" : "required",
