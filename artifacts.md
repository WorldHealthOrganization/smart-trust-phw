...
| [ICVP.Core CodeSystem for Data Elements](CodeSystem-ICVP.Core.md) | CodeSystem for ICVP.Core Data Elements from the Digital ICVP Core Data Dictionary |
...
| | |
| :--- | :--- |
| [ConceptMap to and from ICVP.Core Data Elements](ConceptMap-ICVP.Core.ConceptMap.md) | Mapping to and from ICVP.Core Data Dictionary to other code systems. |
